...
const Form = LoadingGif(lazy(() => import("../pages/form/Form")));
...
const FAQ = LoadingGif(lazy(() => import("../pages/faq/FAQ")));
const Geography = LoadingGif(lazy(() => import("../pages/charts/Geography")));
const Calendar = LoadingGif(lazy(() => import("../pages/calendar/Calendar")));
